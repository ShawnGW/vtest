...
public class InitTelSmallDieDieBean implements Rawdata{
	...
	public InitTelSmallDieDieBean(File mapping,HashMap<String, String> daResultMap,HashMap<String, String> waferIdDaResultMap,HashMap<String, String> basicsInfor) throws IOException, ParserConfigurationException, SAXException {
