...
public class TextReportModel4 extends FTPRealseModel implements Text_Report{
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce,String FileName)
		...
		for (int k = 0; k < Filelist.length; k++) {			
			...
			File[] filelist=new File("/TestReport/CustReport/"+CustomerCode+"/"+Device+"/"+Lot+"/"+CP+"/").listFiles();
			...
			String startTime="20"+TestStartTime_R.substring(0, 2)+"/"+TestStartTime_R.substring(2, 4)+"/"+TestStartTime_R.substring(4, 6)+" "+TestStartTime_R.substring(6, 8)+":"+TestStartTime_R.substring(8, 10)+":00";
			String endTime="20"+TestEndTime_R.substring(0, 2)+"/"+TestEndTime_R.substring(2, 4)+"/"+TestEndTime_R.substring(4, 6)+" "+TestEndTime_R.substring(6, 8)+":"+TestEndTime_R.substring(8, 10)+":00";
			out.print("[BOF]"+"\r\n");
