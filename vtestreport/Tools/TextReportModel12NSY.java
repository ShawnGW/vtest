...
public class TextReportModel12NSY extends FTPRealseModel implements Text_Report {
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce,String FileName)
		...
		for (int k = 0; k < Filelist.length; k++) {
			...
			Integer MapCols_R=Integer.valueOf(properties.get("Map Cols"));
			Integer MapRows_R=Integer.valueOf(properties.get("Map Rows"));
			String[][] MapCell_R=TurnNighteenDegree.Turn(parseRawdata.getAllDiesDimensionalArray(), MapRows_R,MapCols_R);
			...
			for ( int i = TestDie_MinX_R-3; i <TestDie_MaxX_R+7; i++) {
				for (int j = TestDie_MinY_R-3; j < TestDie_MaxY_R+3; j++) {
						try {
