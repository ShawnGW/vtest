		...
		try {			
			...
			for (int i =0; i< Prober_Mappings.length; i++) {
				try {
					...
					ID_Sheet.getRow(9).getCell(1).setCellValue(TestEndTime_R.substring(0, 2)+"-"+TestEndTime_R.substring(2,4)+"-"+TestEndTime_R.substring(4,6)+" "+TestEndTime_R.substring(6,8)+":"+TestEndTime_R.substring(8,10));
					ID_Sheet.getRow(8).getCell(1).setCellValue(Time.substring(0, 2)+"-"+Time.substring(2,4)+"-"+Time.substring(4,6)+" "+Time.substring(6,8)+":"+Time.substring(8,10));
					if (Notch_R.equals("UP")) 
						ID_Sheet.getRow(7).getCell(1).setCellValue(0);
					if (Notch_R.equals("RIGHT")) 
						ID_Sheet.getRow(7).getCell(1).setCellValue(90);
					if (Notch_R.equals("DOWN")) 
						ID_Sheet.getRow(7).getCell(1).setCellValue(180);
					if (Notch_R.equals("LEFT")) 
						ID_Sheet.getRow(7).getCell(1).setCellValue(270);
