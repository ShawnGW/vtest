...
//		/System.out.println(Lot_infor[9]);
		...
		for (String key : keys) {
			if (!key.equals("0")&&!key.equals("S")) {
				...
				//BinInforWriteToMes.Write(Lot_R, Lot_R.split("\\.")[0]+"-"+Slot_number, Integer.valueOf(key), Bin_Summary.get(key), CP_R);
			}
		}
		out.flush();
		out.close();
		return waferid.trim();
//        Result_Array.add(waferid);
//        Result_Array.add(wafer_number);
//        Result_Array.add(Cassette_number);
//        Result_Array.add(Slot_number);
//        Result_Array.add(Test_Start_Time);
//        Result_Array.add(Test_End_Time);
//        Result_Array.add(Row_Sum);
//        Result_Array.add(Mapping);
//        Result_Array.add(Total_Pass);
//        Result_Array.add(Total_Fail);
//        Result_Array.add(Total_Die);
//        Result_Array.add(Min_X);
//        Result_Array.add(Min_Y);
//        Result_Array.add(Max_X);
//        Result_Array.add(Max_Y);
//        Result_Array.add(Bin_Summary);
        
        
        
        
/*        String Waferid_R=(String) Result_Array.get(0);
        String wafer_number_R=(String) Result_Array.get(1);
        String Cassette_number_R=(String) Result_Array.get(2);
        String Slot_number_R=(String) Result_Array.get(3);
        String Test_Count_R=(String) Result_Array.get(4);
        Integer Passdie_R=(Integer) Result_Array.get(5);
        Integer Faildie_R=(Integer) Result_Array.get(6);
        Integer Totaldie_R=(Integer) Result_Array.get(7);
        String Test_Start_Time=(String) Result_Array.get(8);
        String Test_End_Time=(String) Result_Array.get(9);
        String Row_Sum_R=(String)Result_Array.get(10);
        String[][] Mapping_R=(String[][]) Result_Array.get(11);
        Integer Total_Pass_R=(Integer) Result_Array.get(12);
        Integer Total_Fail_R=(Integer) Result_Array.get(13);
        Integer Total_Die_R=(Integer) Result_Array.get(14);
        Integer Min_X_R=(Integer) Result_Array.get(15);
        Integer Min_Y_R=(Integer) Result_Array.get(16);
        Integer Max_X_R=(Integer) Result_Array.get(17);
        Integer Max_Y_R=(Integer) Result_Array.get(18);
        @SuppressWarnings("unchecked")
		HashMap<String, Integer> Bin_Summary_R=(HashMap<String, Integer>) Result_Array.get(19);
        */
