...
public class OpusProberMappingGenerateRawdata {
	private final File dataSourceP=new File("/prod/prober/OPUS/mapup/");
	private final File dataSourcePMapdown=new File("/prod/prober/OPUS/mapdown/");
	boolean smallDie=false;
	public static void main(String[] args) throws IOException {
		OpusProberMappingGenerateRawdata tel=new OpusProberMappingGenerateRawdata();
		tel.generate();
	}
