...
public class TskProberMapping3KGenerateRawdata {
	private final File dataSourceUF=new File("/prod/prober/TSK/UF3000/mapup");
	private final File dataSourceUFMapdown=new File("/prod/prober/TSK/UF3000/mapdown");
	public static void main(String[] args) throws IOException {
		TskProberMapping3KGenerateRawdata tsk=new TskProberMapping3KGenerateRawdata();
		tsk.generate();            
	}
